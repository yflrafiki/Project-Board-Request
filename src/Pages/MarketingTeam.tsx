...
export const MarketingTeam = () => {
  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 xl:px-8 w-full max-w-screen-xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Marketing Team Tasks</h1>
        <p className="text-sm text-gray-500">Visual breakdown of all marketing-related tasks</p>
      </div>

      <div className="bg-white shadow rounded-xl border border-gray-200 mb-6 px-4 py-4">
        <h2 className="text-blue-700 font-semibold mb-2">Marketing Tasks</h2>
