...
export const DesignTeam = () => {
  ...
  const pieData = STATUS_ORDER.map((status) => ({
    name: status,
    value: designTasks.filter((r) => r.status === status).length,
  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 xl:px-8 w-full">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">Visual breakdown of all design-related tasks</p>
      </div>

      <div className="bg-white shadow rounded-xl border border-gray-200 mb-6 px-4 py-4">
        <h2 className="text-blue-700 font-semibold mb-2">Design Tasks</h2>
